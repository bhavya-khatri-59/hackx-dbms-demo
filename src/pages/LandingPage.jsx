...
        transition={{ duration: 0.6, delay: 0.1 }}
      // *** THIS IS THE FIX: Increased gap and margin-bottom for more space ***
...
            <img src={section.image} alt={section.title} className={`w-full ${section.height} object-cover rounded-2xl transition-transform duration-700 hover:scale-110`} />
