...
const LandingPage = () => {
  ...
  const aboutSections = [
    {
      ...
      height: 'h-30' // 288px - larger for main event
    },
    {
    ...
    },
    {
      ...
      height: 'h-60' // 240px - medium-large size
    }
  ];
      ...
      >
        <motion.div whileHover={{ scale: 1.05 }} className="w-full lg:w-1/2">
          <div className="relative overflow-hidden rounded-2xl shadow-2xl">
            <img src={section.image} alt={section.title} className={`w-full ${section.height} object-cover transition-transform duration-700 hover:scale-110`} />
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <div className="relative z-10 min-h-screen smooth-scroll">
        {/* Top Logos */}
        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
          <motion.h1
            ...
            className="rubik-doodle-shadow-regular text-6xl md:text-8xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"
          >
            HackXpertise 2.0
          </motion.h1>
          <p className="varela-round-regular text-xl md:text-2xl text-gray-300 font-bold mt-10">
            Hack like a pro !
          </p>
        </div>

        {/* About Sections */}
        <div className="relative z-10 max-w-6xl mx-auto mt-12 px-2 w-full varela-round-regular pb-20">
          <motion.div
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 varela-round-regular">
