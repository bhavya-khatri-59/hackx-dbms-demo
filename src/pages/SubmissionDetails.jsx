...
  const [viewingRound, setViewingRound] = useState(1);
  // Add figmaUrl to round1Data state
  const [round1Data, setRound1Data] = useState({ problemStatement: '', description: '', pptTemplateURL: '', figmaUrl: '' });
...
                  <div><strong className="text-gray-800 dark:text-gray-200 block mb-1" style={{ color: '#E5E7EB' }}>PPT:</strong> <a href={currentSubmission.ppttemplateurl || currentSubmission.pptTemplateURL} className="text-blue-500 hover:underline break-all">{currentSubmission.ppttemplateurl || currentSubmission.pptTemplateURL}</a></div>
                  <div><strong className="text-gray-800 dark:text-gray-200 block mb-1" style={{ color: '#E5E7EB' }}>Figma URL:</strong> <a href={currentSubmission.figmaurl} className="text-blue-500 hover:underline break-all">{currentSubmission.figmaurl}</a></div>
                </>
              ) : (
                <>
...
                    <input type="url" name="pptTemplateURL" value={round1Data.pptTemplateURL} onChange={handleRound1Change} className="w-full px-4 py-3 pl-12 bg-black/50 border border-gray-600/50 text-white rounded-lg focus:ring-2 focus:ring-yellow-500/50 focus:border-transparent transition-all" placeholder="PPT Template URL" required />
                  </div>
                  <div className="relative">
                    <Figma className="absolute left-4 top-3.5 w-5 h-5 text-gray-400" />
                    <input type="url" name="figmaUrl" value={round1Data.figmaUrl} onChange={handleRound1Change} className="w-full px-4 py-3 pl-12 bg-black/50 border border-gray-600/50 text-white rounded-lg focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all" placeholder="Figma URL (A Blank File with which you'll work)" />
                  </div>
                </>
              ) : (
                <>
...
                      <input type="url" name="githubURL" value={round2Data.githubURL} onChange={handleRound2Change} className="w-full px-4 py-3 pl-12 bg-black/50 border border-gray-600/50 text-white rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all" placeholder="GitHub Repository URL" required />
                  </div>
                   <div className="relative">
                      <Figma className="absolute left-4 top-3.5 w-5 h-5 text-gray-400" />
                      <input type="url" name="figmaURL" value={round2Data.figmaURL} onChange={handleRound2Change} className="w-full px-4 py-3 pl-12 bg-black/50 border border-gray-600/50 text-white rounded-lg focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all" placeholder="Figma Design URL" required />
                  </div>
                  <div className="relative">
                      <FileText className="absolute left-4 top-3.5 w-5 h-5 text-gray-400" />
                      <input type="url" name="pptURL" value={round2Data.pptURL} onChange={handleRound2Change} className="w-full px-4 py-3 pl-12 bg-black/50 border border-gray-600/50 text-white rounded-lg focus:ring-2 focus:ring-yellow-500/50 focus:border-transparent transition-all" placeholder="Presentation URL (Drive Link)" required />
                  </div>
                </>
              )}
              {/* Common Description */}
